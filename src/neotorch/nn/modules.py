"""Layer and loss modules composed from neotorch primitive operations.
    ...
    def forward(self, tensor: Any) -> Any:
        ...
        Args:
            tensor: Flat two-mode input tensor whose second mode extent equals
                ``in_features`` and whose backing data class matches the
                parameters (CPU).
...
class MSELoss(Module):
    ...
    def forward(self, prediction: Any, target: Any) -> Any:
        ...
        Args:
            ...
            target: Target tensor with the same layout and backing data class
...
class ReLU(Module):
    """Module wrapper around :func:`neotorch.relu`.
...
class Sigmoid(Module):
    """Module wrapper around :func:`neotorch.sigmoid`.
...
class Tanh(Module):
    """Module wrapper around :func:`neotorch.tanh`.
...
class GELU(Module):
    """Module wrapper around :func:`neotorch.gelu`.
...
class SiLU(Module):
    """Module wrapper around :func:`neotorch.silu`.
...
class Softplus(Module):
    """Module wrapper around :func:`neotorch.softplus`.
...
class ELU(Module):
    """Module wrapper around :func:`neotorch.elu`.
...
class LeakyReLU(Module):
    """Module wrapper around :func:`neotorch.leaky_relu`.
