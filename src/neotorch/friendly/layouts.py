...
def column_major(*extents: int) -> Layout:
    ...
    ``(1, 2, 6)``. This matches the convention used throughout the neotorch
    test suite and ``neotorch.nn``.
    ...
    Examples:
        ...
        >>> from neotorch.friendly import column_major
...
def row_major(*extents: int) -> Layout:
    ...
    Examples:
        >>> from neotorch import Layout, Shape, Stride
        >>> from neotorch.friendly import row_major
