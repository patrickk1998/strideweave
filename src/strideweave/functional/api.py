...
def mul(tensor: Any, scalar: Any) -> Any:
    ...
    inputs dispatch to scalar multiplication for the tensor's carrier.
...
def reduce(tensor: Any, description: Any = _REDUCE_DESCRIPTION_MISSING) -> Any:
    ...
    Args:
        ...
        description: Optional StrideWeave layout reduce command.
